...
class DecimalsControl extends Component<IDecimalControl> {
  public handleDecimalChange(ev: React.ChangeEvent) {
    ...
    return (
      <div className={styles.control}>
        ...
        <select
          ...
          onChange={(e) => this.handleDecimalChange(e)} defaultValue={this.props.decimals}
        >
